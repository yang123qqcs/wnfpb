...
function openwzjc()
{
        ...
        window.open("/wzjc/wzjc.htm?wzjcurl=" + url + "&wzjctitle=" + title ,"","height=460,width=500,top=100,left=200,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no");
}
